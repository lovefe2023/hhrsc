      ...
      <main className="flex-1 overflow-y-auto p-4 space-y-4 pb-24">
        <Link to="/order/1" className="block rounded-xl bg-white dark:bg-slate-900 p-4 shadow-sm border border-slate-100 dark:border-slate-800">
          ...
          <div className="flex gap-4">
            <div className="h-20 w-20 shrink-0 bg-slate-100 dark:bg-slate-800 rounded-lg bg-center bg-no-repeat bg-cover" style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuBAT0wc_nFUQ2dMoKmnucaWk4ZTBACJ1tDa3igwZ0t5l1K8CfWmowpbBDSUjmwegkPT7AvE4dPhBUnsUZf8xwxif-0fjB-AszgmBb6aHDn8-dw_i0sHU4pOjEZM3VAuo9vlr1oF3egxsHqukCVaml856OaMzjpKZnhdq__M8mwPKBfI_JYKxLSENjqdEk_F4G_nzqyaio27h0atFpEHhKwI_YAPRB5ekJSutnMvb_8zjwUs-0nYIUsT6g4DARKD5XYX_CmIhUNNXHI')" }}></div>
            <div className="flex flex-col flex-1 min-w-0">
              <p className="text-slate-900 dark:text-slate-100 text-sm font-bold truncate">Premium 无线头戴式耳机</p>
              <p className="text-slate-500 dark:text-slate-400 text-xs mt-1">黑色, 主动降噪</p>
              <div className="flex items-end justify-between mt-auto">
                <p className="text-slate-900 dark:text-slate-100 text-base font-bold">¥299.00</p>
        ...
        <Link to="/order/2" className="block rounded-xl bg-white dark:bg-slate-900 p-4 shadow-sm border border-slate-100 dark:border-slate-800">
          ...
          <div className="flex gap-4">
            <div className="h-20 w-20 shrink-0 bg-slate-100 dark:bg-slate-800 rounded-lg bg-center bg-no-repeat bg-cover" style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuALEA1kTZO5fUe5ZRIDeXFedOTNURRqfujc5KJDVVvm2DFr7gJIji7svcJREvaOqsau6dlUhGlMBftFngrxwRXVHCzofdFdwIJqU6-Cp9rX_ELvgNoL7NvTqSo42sj2uC96v0H4hkWZEUXU3qtsKDpM2Laj8ep62ZcOwP_7B_ydeF_UGHqwiP2IW6U4OQ04Ie50Su8KP_ki1OMOzcUAkx-iEO_J8OaOJA_Cus5Uba3QGJdEgergKUFGxg3BJMlZEE4yJ1lE62_N_VA')" }}></div>
            <div className="flex flex-col flex-1 min-w-0">
              <p className="text-slate-900 dark:text-slate-100 text-sm font-bold truncate">智能手表 Series 7</p>
              <p className="text-slate-500 dark:text-slate-400 text-xs mt-1">44mm, 午夜色铝金属</p>
              <div className="flex items-end justify-between mt-auto">
        ...
        <Link to="/order/3" className="block rounded-xl bg-white dark:bg-slate-900 p-4 shadow-sm border border-slate-100 dark:border-slate-800 opacity-90">
          ...
          <div className="flex gap-4">
            <div className="h-20 w-20 shrink-0 bg-slate-100 dark:bg-slate-800 rounded-lg bg-center bg-no-repeat bg-cover" style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuBvGRZ_NcUok0zrQ9w5mM0JtF4_NB5gjT9vqTYu1Mn9N8JKlVUCa5f7LAgzBRa55s6_pTSt41c30TLxCUFaCEX5ReYavd_hiC5UX4eCmB_TYV316VjtOlD_xGWSBdSBeZTDvQA_t_nygXFcXZRp45w97is5xPmkOnpPrO6fPn0bONZJfjzMFzhLNNqeE4LTLYubr-Xe5NrOFWcVZphzBmlk29A0IQVrakDALrwKhKF96GFHpDv0JTxk5ilxzczqOZGyGw6SU_-TxMg')" }}></div>
            <div className="flex flex-col flex-1 min-w-0">
              <p className="text-slate-900 dark:text-slate-100 text-sm font-bold truncate">Ultra Boost 运动跑步鞋</p>
              <p className="text-slate-500 dark:text-slate-400 text-xs mt-1">红色 / 42码</p>
              <div className="flex items-end justify-between mt-auto">
                <p className="text-slate-900 dark:text-slate-100 text-base font-bold">¥180.00</p>
                <p className="text-slate-400 text-xs">x1</p>
              </div>
            </div>
          </div>
