    ...
    <div className="flex-1 flex flex-col overflow-hidden bg-[#fafafa] text-[#1a1a1a] relative font-sans">
        ...
        <div className="bg-white/80 backdrop-blur-md border border-white/40 rounded-2xl px-4 py-2 flex items-center justify-between shadow-[0_10px_25px_-5px_rgba(0,0,0,0.05),0_8px_10px_-6px_rgba(0,0,0,0.05)]">
          <div className="flex items-center space-x-3">
            <div className="relative">
              <img alt="Inviter Avatar" className="w-9 h-9 rounded-full border-2 border-[#ff7a18]/20" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBpH8Yq1cdjXHoxw0kH3ynA77VT5OEVN3hn1p5gdlXKMZkuAWQkc4dwmiUYwTQdmxhxfA-nrFZvCa-RBN-kH9EX2UVpq7Aq4nMh8vxj-I-UH0q6tliXvDjBJBsjVoYa-VfRhM134CEmnv2eOJMC9jAeN-TVJYnUWl6b2HUycpBuKzfb-Qcm2UPBOhZMaCJCbJErRCoH-Fki41WPfNsOSg9k0CXgoNK-BkUm32ikNcuoI-d9L40HgcmyKMeefEtP6Jn4SjX7qVKuocw"/>
              <span className="absolute -bottom-1 -right-1 bg-[#ff7a18] text-white text-[8px] px-1 rounded-full border border-white">VIP</span>
            </div>
          ...
          <div className="text-[11px] text-gray-500 bg-gray-100 px-2 py-1 rounded-lg">
            已成功邀请 <span className="text-[#ff7a18] font-bold">12</span> 位
          </div>
        </div>
      </header>
      ...
      <main className="flex-1 overflow-y-auto pb-24">
        <section className="relative px-4 pt-4 pb-16 overflow-hidden">
          <div className="rounded-[2rem] p-8 text-white relative overflow-hidden shadow-[0_10px_25px_-5px_rgba(0,0,0,0.05),0_8px_10px_-6px_rgba(0,0,0,0.05)]" style={{ background: 'linear-gradient(145deg, #ff7a18 0%, #ffb347 100%)' }}>
            ...
            <div className="relative z-10 text-center">
              ...
              <Link to="/register" className="inline-block bg-white text-[#ff7a18] px-8 py-3.5 rounded-full font-bold text-sm active:scale-95 transition-all" style={{ boxShadow: '0 4px 15px rgba(255, 122, 24, 0.3), inset 0 1px 0 rgba(255, 255, 255, 0.4)' }}>
                立即加入合伙人
              </Link>
            </div>
          </div>
        ...
        <section className="px-6 -mt-10 relative z-10">
          <div className="bg-white p-6 rounded-3xl border border-gray-50 flex justify-around shadow-[0_10px_25px_-5px_rgba(0,0,0,0.05),0_8px_10px_-6px_rgba(0,0,0,0.05)]">
            <div className="flex flex-col items-center space-y-2">
              <div className="w-12 h-12 bg-orange-50 rounded-2xl flex items-center justify-center text-[#ff7a18]">
        ...
        <section className="mt-12 px-6">
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="bg-white p-4 rounded-2xl border border-gray-50 text-center shadow-[0_10px_25px_-5px_rgba(0,0,0,0.05),0_8px_10px_-6px_rgba(0,0,0,0.05)]">
              <div className="w-10 h-10 bg-gradient-to-br from-orange-400 to-orange-500 rounded-xl flex items-center justify-center mx-auto mb-3 shadow-lg shadow-orange-200 text-white">
        ...
        <section className="mt-12 px-6">
          ...
          <div className="relative space-y-4">
            <div className="flex items-center space-x-4">
              <div className="flex-shrink-0 w-12 h-12 bg-white rounded-2xl flex items-center justify-center border border-orange-100 z-10 shadow-[0_10px_25px_-5px_rgba(0,0,0,0.05),0_8px_10px_-6px_rgba(0,0,0,0.05)]">
                <span className="material-symbols-outlined text-[#ff7a18]">share</span>
              </div>
              <div className="flex-grow bg-white p-4 rounded-2xl border border-gray-50 flex justify-between items-center shadow-[0_10px_25px_-5px_rgba(0,0,0,0.05),0_8px_10px_-6px_rgba(0,0,0,0.05)]">
                ...
                <span className="text-[10px] font-medium bg-orange-50 text-[#ff7a18] px-2 py-0.5 rounded-full">入门</span>
              </div>
            </div>
            <div className="flex justify-center -my-2 relative">
              <div className="w-[2px] h-6 bg-gradient-to-b from-[#ff7a18] to-transparent opacity-30"></div>
            </div>
            <div className="flex items-center space-x-4 pl-4">
              <div className="flex-shrink-0 w-12 h-12 bg-white rounded-2xl flex items-center justify-center border border-orange-200 z-10 shadow-[0_10px_25px_-5px_rgba(0,0,0,0.05),0_8px_10px_-6px_rgba(0,0,0,0.05)]">
                <span className="material-symbols-outlined text-[#ff7a18]">shopping_cart_checkout</span>
              </div>
              <div className="flex-grow bg-white p-4 rounded-2xl border border-orange-100 flex justify-between items-center shadow-[0_0_20px_rgba(255,122,24,0.15)]">
                <span className="font-bold text-sm text-gray-800">第二阶段：好友下单购买</span>
                <span className="text-[10px] font-medium bg-orange-100 text-[#ff7a18] px-2 py-0.5 rounded-full">转化</span>
              </div>
            </div>
            <div className="flex justify-center -my-2 relative">
              <div className="w-[2px] h-6 bg-gradient-to-b from-[#ff7a18] to-transparent opacity-30"></div>
            ...
            <div className="flex items-center space-x-4 pl-8">
              <div className="flex-shrink-0 w-12 h-12 bg-[#ff7a18] rounded-2xl flex items-center justify-center shadow-lg shadow-orange-200 z-10 text-white">
                <span className="material-symbols-outlined">redeem</span>
              </div>
              <div className="flex-grow bg-gradient-to-r from-[#ff7a18]/5 to-white p-4 rounded-2xl border-l-4 border-[#ff7a18] flex justify-between items-center shadow-[0_10px_25px_-5px_rgba(0,0,0,0.05),0_8px_10px_-6px_rgba(0,0,0,0.05)]">
                <span className="font-extrabold text-sm text-gray-800">第三阶段：获得 20% 佣金</span>
                <span className="text-[10px] font-bold text-[#ff7a18]">获利</span>
              </div>
            </div>
            <div className="flex justify-center -my-2 relative">
              <div className="w-[2px] h-6 bg-gradient-to-b from-[#ff7a18] to-transparent opacity-30"></div>
            ...
            <div className="flex items-center space-x-4 pl-12">
              <div className="flex-shrink-0 w-12 h-12 bg-orange-600 rounded-2xl flex items-center justify-center shadow-lg shadow-orange-300 z-10 text-white">
              ...
              <div className="flex-grow bg-white p-4 rounded-2xl border border-gray-100 flex justify-between items-center shadow-[0_10px_25px_-5px_rgba(0,0,0,0.05),0_8px_10px_-6px_rgba(0,0,0,0.05)]">
                ...
                <span className="material-symbols-outlined text-[#ff7a18] text-xl">star</span>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="mt-16 px-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <span className="text-[#ff7a18] text-[10px] font-bold bg-orange-50 px-2 py-0.5 rounded">已有2000+加入</span>
          </div>
          <div className="space-y-4">
            <div className="bg-white p-5 rounded-3xl border border-gray-50 flex items-center space-x-4 shadow-[0_10px_25px_-5px_rgba(0,0,0,0.05),0_8px_10px_-6px_rgba(0,0,0,0.05)]">
              ...
              <div className="flex-grow">
                ...
                <div className="flex items-center text-[#ff7a18] font-bold text-sm">
        ...
        <section className="mt-16 px-6">
          <div className="bg-gradient-to-br from-orange-50 to-white border border-orange-100 rounded-[2.5rem] p-10 text-center relative overflow-hidden">
            <div className="absolute -top-4 -right-4 w-24 h-24 bg-[#ff7a18]/5 rounded-full"></div>
            <h3 className="text-sm font-bold text-gray-600 mb-4 tracking-widest uppercase">合伙人准入门槛</h3>
            <div className="flex items-baseline justify-center mb-6">
              <span className="text-2xl font-bold text-[#ff7a18] mr-1">¥</span>
              <span className="text-6xl font-black text-[#ff7a18] tracking-tighter">3300</span>
            </div>
            <div className="inline-block px-4 py-2 bg-white rounded-2xl shadow-sm border border-orange-50 mb-4">
          ...
          <div className="space-y-3">
            <details className="group bg-white rounded-2xl border border-gray-100 overflow-hidden transition-all shadow-[0_10px_25px_-5px_rgba(0,0,0,0.05),0_8px_10px_-6px_rgba(0,0,0,0.05)]" open>
              ...
              <div className="px-5 pb-5 text-xs text-gray-500 leading-relaxed border-t border-gray-50 pt-4">
                完全不需要。我们采用最先进的<span className="text-[#ff7a18] font-medium">云仓代发</span>模式，您只需负责线上分享。货源采集、分拣、打包及售后物流均由平台总部统一负责。
              </div>
            </details>
            <details className="group bg-white rounded-2xl border border-gray-100 overflow-hidden transition-all shadow-[0_10px_25px_-5px_rgba(0,0,0,0.05),0_8px_10px_-6px_rgba(0,0,0,0.05)]">
              ...
              <div className="px-5 pb-5 text-xs text-gray-500 leading-relaxed border-t border-gray-50 pt-4">
                收益实时到账。所有已结算收益均可即时在个人中心申请提现，支持提现至<span className="text-[#ff7a18] font-medium">银行卡或微信钱包</span>，通常24小时内到账。
              </div>
            </details>
            <details className="group bg-white rounded-2xl border border-gray-100 overflow-hidden transition-all shadow-[0_10px_25px_-5px_rgba(0,0,0,0.05),0_8px_10px_-6px_rgba(0,0,0,0.05)]">
              <summary className="p-5 font-bold text-sm cursor-pointer list-none flex justify-between items-center text-gray-700 [&::-webkit-details-marker]:hidden">
              ...
              <div className="px-5 pb-5 text-xs text-gray-500 leading-relaxed border-t border-gray-50 pt-4">
                当然可以。我们提供<span className="text-[#ff7a18] font-medium">导师1对1指导</span>及完整的商学院培训课程。同时提供现成的推文素材、海报和视频，小白也能轻松上手。
              </div>
            </details>
          </div>
        </section>
      ...
      <div className="absolute bottom-4 left-4 right-4 z-[60]">
        <Link to="/register" className="w-full h-14 text-white font-bold text-lg rounded-2xl shadow-xl shadow-orange-200 flex items-center justify-between px-8 active:scale-[0.98] transition-all" style={{ background: 'linear-gradient(90deg, #ff7a18 0%, #ff9d47 100%)' }}>
          <span className="flex items-center">
            <span className="material-symbols-outlined mr-2">verified_user</span>
            立即成为合伙人
          </span>
          <span className="text-white/80 font-normal">¥3300</span>
        </Link>
      </div>
    </div>
  );
