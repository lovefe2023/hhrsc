  ...
  return (
    <div className="max-w-md mx-auto bg-white dark:bg-background-dark min-h-screen flex flex-col shadow-xl font-display text-slate-900 dark:text-slate-100">
      ...
      <div className="px-6 pt-10 pb-6">
        <h1 className="text-3xl font-bold tracking-tight text-slate-900 dark:text-white">加入 H5 商城</h1>
        <p className="text-slate-500 dark:text-slate-400 mt-2">创建一个账户来发现独家优惠并开始您的购物之旅。</p>
      </div>
      ...
      <div className="pb-10 flex justify-center opacity-20 grayscale">
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-xl tracking-tight">H5 MALL</span>
        </div>
      </div>
    </div>
  );
