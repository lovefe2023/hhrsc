      ...
      <main className="flex-1 overflow-y-auto pb-24">
        <div className="px-4 py-6 @container">
          <div className="flex flex-col overflow-hidden rounded-xl shadow-lg bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700">
            <div className="w-full bg-center bg-no-repeat aspect-[3/4] bg-cover relative" style={{ backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuCXa6Q0gcq7Ypj9-51yfqClAJymvlAveLsO-NPdlN0ka-TNzLhg8NuNgrMnJMzMRJrKFQ7CU2r3UQH2q_Xr7PgG_7MbcZcyYCK1u_TzSgfPOEYfk4U4C0Ov9Y0r6jS18oePDFBwykfWLgmUt9HtoCZ-BFsnbZM4Wu9FlQAsCxkUXA6fM8Gfc96KNMD6x17TC60_t-wFHDXE7TKj1QnHOEm_tKVCyReUm1vHVYLgjMvBNaX7Yy8v9vh4QvEMDmCSVRTjTAjomyWIrD4")' }}>
